  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 border-t border-border/60 px-8 py-5 text-[0.6875rem] text-muted-foreground sm:px-10">
      <nav className="flex items-center gap-5">
        <a href="https://github.com/steiner-co/pingboard/discussions" className="transition-colors hover:text-foreground">
          Community
        </a>
        <a href="https://github.com/steiner-co/pingboard/releases" className="transition-colors hover:text-foreground">
          Changelog
        </a>
        <a href="https://github.com/steiner-co/pingboard/blob/main/LICENSE" className="transition-colors hover:text-foreground">
          License
        </a>
      ...
      <div className="flex items-center gap-3">
        <a href="https://github.com/steiner-co/pingboard" aria-label="GitHub" className="transition-colors hover:text-foreground">
