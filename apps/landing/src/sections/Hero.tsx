  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 border-t border-border/60 px-8 py-5 text-[0.6875rem] text-muted-foreground sm:px-10">
      <nav className="flex items-center gap-5">
        <a href="https://github.com/steiner-co/pingboard/discussions" className="transition-[color,transform] duration-150 ease-out hover:text-foreground active:scale-[0.97]">
          Community
        </a>
        <a href="https://github.com/steiner-co/pingboard/releases" className="transition-[color,transform] duration-150 ease-out hover:text-foreground active:scale-[0.97]">
          Changelog
        </a>
        <a href="https://github.com/steiner-co/pingboard/blob/main/LICENSE" className="transition-[color,transform] duration-150 ease-out hover:text-foreground active:scale-[0.97]">
          License
        </a>
        <a href="#docs" className="transition-[color,transform] duration-150 ease-out hover:text-foreground active:scale-[0.97]">
          Docs
        </a>
      </nav>
      <div className="flex items-center gap-3">
        <a href="https://github.com/steiner-co/pingboard" aria-label="GitHub" className="transition-[color,transform] duration-150 ease-out hover:text-foreground active:scale-[0.97]">
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 flex-col justify-center px-8 py-10 sm:px-10 lg:py-0">
        ...
        <a
          href="#features"
          className="mt-10 inline-flex w-fit items-center gap-2 rounded-full border border-border/70 bg-background/40 px-3 py-1 text-[0.6875rem] text-muted-foreground transition-[color,transform] duration-150 ease-out hover:text-foreground active:scale-[0.98]"
        >
          <span className="relative inline-flex h-1.5 w-1.5">
            <span
              className="absolute inset-0 motion-safe:animate-ping rounded-full bg-success/60"
